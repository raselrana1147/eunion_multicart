	            ...
	            <div class="row">
	                <div class="col-xl-10 col-lg-12 m-auto">
	                    <section class="row align-items-center mb-50">
	                        <div class="col-lg-6">
	                            <img src="{{ asset('assets/frontend/assets/imgs/page/about-1.png') }}" alt="" class="border-radius-15 mb-md-3 mb-lg-0 mb-sm-4" />
	                            ...
	                            <div class="pl-25">
	                                ...
	                                <div class="carausel-3-columns-cover position-relative">
	                                    ...
	                                    <div class="carausel-3-columns" id="carausel-3-columns">
	                                        <img src="{{ asset('assets/frontend/assets/imgs/page/about-2.png')}}" alt="" />
	                                        <img src="{{ asset('assets/frontend/assets/imgs/page/about-3.png')}}" alt="" />
	                                        <img src="{{ asset('assets/frontend/assets/imgs/page/about-4.png')}}" alt="" />
	                                        <img src="{{ asset('assets/frontend/assets/imgs/page/about-2.png')}}" alt="" />
	                                    </div>
	                                </div>
	                            </div>
	                    ...
	                    <section class="row align-items-center mb-50">
	                        <div class="row mb-50 align-items-center">
	                            <div class="col-lg-7 pr-30">
	                                <img src="{{ asset('assets/frontend/assets/imgs/page/about-5.png')}}" alt="" class="mb-md-3 mb-lg-0 mb-sm-4" />
	                            </div>
	                            <div class="col-lg-5">
	        ...
	        <section class="container mb-50 d-none d-md-block">
	            <div class="row about-count">
	                <div class="col-lg-1-5 col-md-6 text-center mb-lg-0 mb-md-5">
	                    <h1 class="heading-1"><span class="count">5000</span>+</h1>
	                    <h4>Total Orders</h4>
	                </div>
	                <div class="col-lg-1-5 col-md-6 text-center">
	                    <h1 class="heading-1"><span class="count">2,25,244</span>+</h1>
	                    <h4>Total Sale</h4>
	                </div>
	                <div class="col-lg-1-5 col-md-6 text-center">
	                                        ...
	                                        <div class="team-card">
	                                            ...
	                                            <div class="content text-center">
	                                                ...
	                                                <div class="social-network mt-20">
	                                                    <a href="#"><img src="{{ asset('assets/frontend/assets/imgs/theme/icons/icon-facebook-brand.svg')}}" alt="" /></a>
	                                                    <a href="#"><img src="{{ asset('assets/frontend/assets/imgs/theme/icons/icon-twitter-brand.svg')}}" alt="" /></a>
	                                                    <a href="#"><img src="{{ asset('assets/frontend/assets/imgs/theme/icons/icon-instagram-brand.svg')}}" alt="" /></a>
	                                                    <a href="#"><img src="{{ asset('assets/frontend/assets/imgs/theme/icons/icon-youtube-brand.svg')}}" alt="" /></a>
	                                                </div>
	                                            </div>
	                                        </div>
	                                    </div>
