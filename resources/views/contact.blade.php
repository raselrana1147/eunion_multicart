                        ...
                        <section class="mb-50">
                            <div class="row mb-60">
                                <div class="col-md-4 mb-4 mb-md-0">
                                    <h4 class="mb-15 text-brand">Brnach Office 1</h4>
                                    {{config('constant.company_address')}}<br />
                                    <abbr title="Phone">Phone:</abbr> {{config('constant.company_phone')}}<br />
                                    <abbr title="Email">Email: </abbr>{{config('constant.company_email')}}<br />
                                    
                                </div>
                                <div class="col-md-4 mb-4 mb-md-0">
                                    <h4 class="mb-15 text-brand">Branch Office 2</h4>
                                    {{config('constant.company_address')}}<br />
                                    <abbr title="Phone">Phone:</abbr>{{config('constant.company_phone')}}<br />
                                    <abbr title="Email">Email: </abbr>{{config('constant.company_email')}}<br />
                                ...
                                <div class="col-md-4">
                                    <h4 class="mb-15 text-brand">Branch Office 3</h4>
                                    {{config('constant.company_address')}}<br />
                                    <abbr title="Phone">Phone:</abbr> {{config('constant.company_phone')}}<br />
                                    <abbr title="Email">Email: </abbr>{{config('constant.company_email')}}<br />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 pl-50 d-lg-block d-none">
                                    <img class="border-radius-15 mt-50" src="{{ asset('assets/frontend/assets/imgs/page/contact-2.png') }}" alt="" />
                                </div>
                            </div>
                        </section>
                    </div>
