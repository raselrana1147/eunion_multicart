@extends('layouts.app')
@section('title',config('constant.company_name').' Search Product')
	        ...
	        <div class="container">
	            <div class="archive-header">
	                <div class="row align-items-center">
	                    <div class="col-xl-3">
		                    <h1 class="mb-15">Product Search Product</h1>
	                            ...
	                            <div class="product-cart-wrap mb-30">
	                                <div class="product-img-action-wrap">
	                                    ...
	                                    <div class="product-action-1">
	                                        <a aria-label="Add To Wishlist" product_id="{{$product->id}}" data-action="{{ route('add_to_wishlist') }}" class="action-btn add_to_wishlist" href="javascript:;"><i class="fi-rs-heart"></i></a>
	                                        <a aria-label="Compare" class="action-btn add_to_comparelist"  product_id="{{$product->id}}" data-action="{{ route('add_to_comparelist') }}" href="javascript:;"><i class="fi-rs-shuffle"></i></a>
	                                ...
	                                <div class="product-content-wrap">
	                                    ...
	                                    <div class="product-card-bottom">
	                                        ...
	                                        <div class="add-cart">
	                                            <a class="add add_to_cart_single" href="javascript:;" product_id="{{$product->id}}" data-action="{{ route('add_to_cart_single') }}"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
	                                        </div>
	                                    </div>
	                                </div>
	                            </div>
