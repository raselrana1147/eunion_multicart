	        ...
	        <div class="container">
	            <div class="archive-header">
	                <div class="row align-items-center">
	                    <div class="col-xl-3">
		                    <h1 class="mb-15">{{$sub_cat->sub_cat_name}}</h1>
		                    <div class="breadcrumb">
		                        <a href="{{ route('front.index') }}" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
		                         <a href="{{ route('product.category_product',$sub_cat->category_id) }}"><span>{{$sub_cat->category->category_name}}</span></a>
		                         {{$sub_cat->sub_cat_name}}</span>
